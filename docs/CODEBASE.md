...
myllm/
  ...
  src/
    ...
    features/                       UI dan orkestrasi per layar
      chat/
        chat-screen.tsx             message list, composer, thinking modal, streaming, compact request stats, Stop, retry, New chat, and compaction separator
...
| `chat/chat-screen.tsx` | Message list, composer, reasoning modal, compact request stats, Send or Stop, partial output, error, retry, New chat, compaction separator, and context controls | `domain/conversation`, `domain/context`, `domain/usage`, `features/chat/use-chat`, `features/setup/use-active-endpoint`, `ui/*` |
