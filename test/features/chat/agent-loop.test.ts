...
import type { ToolActivity, ToolExecutor, ToolRegistry } from '../../../src/domain/tool';
import type { SendResponseResult, StreamToolCall, Transport } from '../../../src/services/transport/contract';
import { recordDiagnostic } from '../../../src/services/diagnostics/diagnostic-ring';
import {
  MAX_TOOL_ROUNDS,
  TOOL_TIMEOUT_MS,
  runAgentLoop,
  type ToolCallPersistence,
} from '../../../src/features/chat/agent-loop';

jest.mock('../../../src/services/diagnostics/diagnostic-ring', () => ({
